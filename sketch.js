...
function draw() {
 background(0);
  ...
  //Descomenta la opción correcta para obtener un número aleatorio entre 1 y 4 
   var green_ballonImage = Math.round(random(1,4));
   var red_ballonImage= Math.round(random(1,4));
   var pink_ballonImage = Math.round(random(1,4));
  var blue_ballonImage = Math.round(random(1,4,2));
  
   if (World.frameCount % 100 == 0) {


            switch(red_ballonImage){
